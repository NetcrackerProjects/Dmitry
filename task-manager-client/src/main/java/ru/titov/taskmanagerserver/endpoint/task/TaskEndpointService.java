 ...
 * 2019-01-16T15:07:23.557+03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "TaskEndpointService",
                  wsdlLocation = "http://localhost:8080/TaskEndpoint?wsdl",
                  targetNamespace = "http://task.endpoint.taskmanagerserver.titov.ru/")
public class TaskEndpointService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://task.endpoint.taskmanagerserver.titov.ru/", "TaskEndpointService");
    public final static QName TaskEndpointPort = new QName("http://task.endpoint.taskmanagerserver.titov.ru/", "TaskEndpointPort");
    static {
        URL url = null;
        try {

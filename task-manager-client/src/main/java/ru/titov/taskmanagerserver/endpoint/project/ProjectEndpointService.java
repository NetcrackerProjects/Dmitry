 ...
 * 2019-01-18T16:56:31.595+03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "ProjectEndpointService",
                  wsdlLocation = "http://localhost:8080/ProjectEndpoint?wsdl",
                  targetNamespace = "http://project.endpoint.taskmanagerserver.titov.ru/")
public class ProjectEndpointService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://project.endpoint.taskmanagerserver.titov.ru/", "ProjectEndpointService");
    public final static QName ProjectEndpointPort = new QName("http://project.endpoint.taskmanagerserver.titov.ru/", "ProjectEndpointPort");
    static {
        URL url = null;
        try {
